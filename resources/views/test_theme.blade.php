...
<body>
				...
				<div class="row">
					<nav class="navbar">
						...
						<div class="navbar-header">
							<a class="navbar-brand" href="home-1.html"><img src="theme/img/logo.png" alt="image"></a>
						</div>
	...
	<div id="rev_slider_2_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.2.6">
		<ul>	<!-- SLIDE  -->
			<li data-index="rs-13" data-transition="slidingoverlayup" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="lib/rev-slider/img/slider-bg.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
				<!-- MAIN IMAGE -->
				<img src="lib/rev-slider/img/slider-bg.jpg"  alt="" title="slider-bg"  width="1920" height="750" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
				<!-- LAYERS -->
				...
				<div class="way-help-section-content">
					<div class="row">
						<div class="col-md-3 col-sm-6">
							<div class="way-help-pic-text text-center colmd3">
								<div class="way-help-pic pb30">
									<img src="theme/img/help-4.png" alt="image">
								</div>
								<!-- /img -->
						...
						<div class="col-md-3 col-sm-6">
							<div class="way-help-pic-text text-center colmd3">
								<div class="way-help-pic pb30">
									<img src="theme/img/help-2.png" alt="image">
								</div>
								<!-- /img -->
								<div class="way-help-text">
									<div class="way-help-head pb20 text-uppercase">
						...
						<div class="col-md-3 col-sm-6">
							<div class="way-help-pic-text text-center colmd3">
								<div class="way-help-pic pb30">
									<img src="theme/img/help-3.png" alt="image">
								</div>
								<!-- /img -->
								<div class="way-help-text">
									<div class="way-help-head pb20 text-uppercase">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="count-right-img pl30 colmd6">
								<img src="theme/img/count-right.jpg" alt="image">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row section-content">
				...
				<div class="recent-causes-content">
					<div class="cause-item">
						<div class="recent-causes-pic-text">
							<div class="recent-causes-pic">
								<img src="theme/img/cause-1.jpg" alt="image">
							</div>
							<!-- /img -->
					...
					<div class="cause-item">
						<div class="recent-causes-pic-text">
							<div class="recent-causes-pic">
								<img src="theme/img/cause-2.jpg" alt="image">
							</div>
							<!-- /img -->
					...
					<div class="cause-item">
						<div class="recent-causes-pic-text">
							<div class="recent-causes-pic">
								<img src="theme/img/cause-3.jpg" alt="image">
							</div>
							<!-- /img -->
							<div class="cause-text pt75 pb50">
								<div class="donate-piechart">
					...
					<div class="cause-item">
						<div class="recent-causes-pic-text">
							<div class="recent-causes-pic">
								<img src="theme/img/cause-4.jpg" alt="image">
							</div>
							<!-- /img -->
							<div class="cause-text pt75 pb50">
								<div class="donate-piechart">
					...
					<div class="cause-item">
						<div class="recent-causes-pic-text">
							<div class="recent-causes-pic">
								<img src="theme/img/cause-5.jpg" alt="image">
							</div>
							<!-- /img -->
							<div class="cause-text pt75 pb50">
								<div class="donate-piechart">
					...
					<div class="cause-item">
						<div class="recent-causes-pic-text">
							<div class="recent-causes-pic">
								<img src="theme/img/cause-6.jpg" alt="image">
							</div>
							<!-- /img -->
							<div class="cause-text pt75 pb50">
								<div class="donate-piechart">
					...
					<div class="cause-item">
						<div class="recent-causes-pic-text">
							<div class="recent-causes-pic">
								<img src="theme/img/cause-7.jpg" alt="image">
							</div>
							<!-- /img -->
							<div class="cause-text pt75 pb50">
								<div class="donate-piechart">
					...
					<div class="cause-item">
						<div class="recent-causes-pic-text">
							<div class="recent-causes-pic">
								<img src="theme/img/cause-9.jpg" alt="image">
							</div>
							<!-- /img -->
							<div class="cause-text pt75 pb50">
								<div class="donate-piechart">
							...
							<div class="latest-news-slide-content">
								<div class="latest-news-slide text-center">
									<div class="slide-quate-pic pb60">
										<img src="theme/img/quate.png" alt="image">
									</div>
									<!-- /slide-quate-pic -->
									...
									<div class="quate-client-pic-text">
										<div class="quate-client-pic pb60">
											<div class="author-pic">
												<img src="theme/img/quate-pic.jpg" alt="image">
											</div>
										</div>
			...
			<div class="row">
				<div class="partner-section-slider">
					<div class="partner-pic">
						<a href=""><img src="theme/img/partner-1.png" alt="image"></a>
					</div>
					<div class="partner-pic">
						<a href=""><img src="theme/img/partner-2.png" alt="image"></a>
					</div>
					<div class="partner-pic">
						<a href=""><img src="theme/img/partner-3.png" alt="image"></a>
					</div>
					<div class="partner-pic">
						<a href=""><img src="theme/img/partner-4.png" alt="image"></a>
					</div>
					<div class="partner-pic">
						<a href=""><img src="theme/img/partner-2.png" alt="image"></a>
					</div>
							...
							<div class="row">
								<div class="col-sm-3">
									<div class="footer-logo pb20">
										<a  href="home-1.html"><img src="theme/img/f-logo.png" alt="image"></a>
									</div>
									...
									<div class="touch-content">
										...
										<div class="newsletter-form">
											...
											<div class="submit-btn">
												<button type="submit" value="Submit"><img src="theme/img/inbox.png" alt="image"></button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-3">
									...
									<div class="footer-gallery pb35">
										<ul class="footer-gallery">
											<li><a href="#"><img src="theme/img/g-1.png" alt="image"></a></li>
											<li><a href="#"><img src="theme/img/g-2.png" alt="image"></a></li>
											<li><a href="#"><img src="theme/img/g-3.png" alt="image"></a></li>
											<li><a href="#"><img src="theme/img/g-4.png" alt="image"></a></li>
											<li><a href="#"><img src="theme/img/g-5.png" alt="image"></a></li>
											<li><a href="#"><img src="theme/img/g-6.png" alt="image"></a></li>
										</ul>
									</div>
								</div>
								<!-- /col-sm-3 -->
	...
	<script type="text/javascript" src="theme/js/circle-progress.js"></script>


	<!-- REVOLUTION JS FILES -->
	<script type="text/javascript" src="lib/rev-slider/js/jquery.themepunch.tools.min.js"></script>
	<script type="text/javascript" src="lib/rev-slider/js/jquery.themepunch.revolution.min.js"></script>

    <!-- SLIDER REVOLUTION 5.0 EXTENSIONS (Load Extensions only on Local File Systems !
    The following part can be removed on Server for On Demand Loading) -->

    <script type="text/javascript" src="lib/rev-slider/js/revolution.extension.actions.min.js"></script>
    
    <script type="text/javascript" src="lib/rev-slider/js/revolution.extension.layeranimation.min.js"></script>
    <script type="text/javascript" src="lib/rev-slider/js/revolution.extension.navigation.min.js"></script>
    <script type="text/javascript" src="lib/rev-slider/js/revolution.extension.parallax.min.js"></script>
    <script type="text/javascript" src="lib/rev-slider/js/revolution.extension.slideanims.min.js"></script>
    <script type="text/javascript" src="lib/rev-slider/js/revolution.extension.video.min.js"></script>
