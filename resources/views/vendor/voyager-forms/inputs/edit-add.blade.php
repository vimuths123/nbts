<li class="dd-item" data-id="{{ $input->id }}" id="input-id-{{ $input->id }}">
    ...
    <div class="panel panel-bordered panel-info">
        ...
        <div class="panel-body">
            <form role="form" action="{{ route('customVoyagerInputUpdate', $input->id) }}"
                    method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 no-bottom-margin">
                        <div class="form-group">
                            <label for="class">Name (Bootstrap Layout)</label>
                            <input name="name" class="form-control" id="class" value="{{ $input->name }}">
                        </div>
                    </div>
                    
                    <div class="col-md-4 no-bottom-margin">
                        <div class="form-group">
                            <label for="class">Grid size (Bootstrap Layout)</label>
                            <input name="grid_size" class="form-control" id="class" value="{{ $input->grid_size }}">
                        </div>
                    </div>

                    <div class="col-md-4 no-bottom-margin">
                        <div class="form-group">
                            <label for="required"> &nbsp;Input Required</label><br/>
                            <input
                                type="checkbox"
                                name="required"
                                id="required"
